...
#include "Components/Graphics/Rendering/Services/Scene/ISceneService.h"
...
namespace TEngine::Components::Graphics::Rendering::Services::Scene::State::Deserialization
{
