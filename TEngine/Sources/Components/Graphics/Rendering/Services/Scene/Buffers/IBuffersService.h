#ifndef TENGINE_IBUFFERS_SERVICE_H
#define TENGINE_IBUFFERS_SERVICE_H
...
namespace TEngine::Components::Graphics::Rendering::Services::Scene::Buffers
{
...
#endif // TENGINE_IBUFFERS_SERVICE_H